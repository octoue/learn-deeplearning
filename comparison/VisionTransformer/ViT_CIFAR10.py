...
def patchify(images,n_patches):
    ...
    patches = torch.zeros(n,n_patches ** 2, h * w * c // n_patches ** 2) # [n,number of patches,patch dimension] [64,64,48]
...
class ViT(nn.Module):
    def __init__(self,chw,n_patches=8,n_blocks=2,hidden_dim=10,n_heads=2,out_dim=10):
...
model = ViT((3,32,32), n_patches=8, n_blocks=2, hidden_dim=10, n_heads=2, out_dim=10).to(device)
